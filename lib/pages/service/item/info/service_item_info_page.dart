...
class ServiceItemInfoPage extends GetView<ServiceItemInfoController> {
  const ServiceItemInfoPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: GetBuilder<ServiceItemInfoController>(
          builder: (_) {
                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        GetBuilder<ServiceItemInfoController>(
                          id: ServiceItemInfoController.idIcon,
                          builder: (context) {
                            if (_.iconUrl == null) {
                              return Container(
                                width: 400,
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          GetBuilder<ServiceItemInfoController>(
                            id: ServiceItemInfoController.idEdit,
                            builder: (_) {
                          ...
                          GetBuilder<ServiceItemInfoController>(
                            id: ServiceItemInfoController.idDelete,
                            builder: (context) {
                              if (_.canDelete) {
                                return Container(
                          ...
                          GetBuilder<ServiceItemInfoController>(
                            id: ServiceItemInfoController.idCommit,
                            builder: (_) {
                              if (_.canCommit) {
                                return Container(
                                  margin: const EdgeInsets.only(left: 20),
  ...
  Widget _infoItemContent(
    ...
    var controller = Get.find<ServiceItemInfoController>();
    return Expanded(
      child: Container(
        width: double.infinity,
  ...
  ServiceItemInfoController _controller() {
    return Get.find<ServiceItemInfoController>();
  }
}
