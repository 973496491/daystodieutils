...
class ServiceItemListPage extends GetView<ServiceItemListController> {
  const ServiceItemListPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: ViewUtils.getAppBar(
        ...
        actions: [
          Padding(
            ...
            child: GetBuilder<ServiceItemListController>(builder: (_) {
              return const Text(
                "搜索",
                style: TextStyle(
          ...
          children: [
            Expanded(
              child: Container(
                ...
                child: GetBuilder<ServiceItemListController>(
                  id: ServiceItemListController.idListView,
                  builder: (_) {
                    return SizedBox(
                      width: 1000,
      ...
      floatingActionButton: SizedBox(
        ...
        height: 100,
        child: GetBuilder<ServiceItemListController>(
          id: ServiceItemListController.idAddBtn,
          builder: (_) {
            if (!_.canEdit) {
              return Container();
            } else {
